...
Endpoints para cálculos y validación
"""
...
from app.db.models import (
    Proyecto, Nudo, Tramo, Calculo, Iteracion, Alerta
)
from app.schemas.schemas import (
    CalculoRequest, CalculoResponse, IteracionItem,
