...
Endpoints para consultas normativas y copiloto LLM
"""
...
async def consultar_normativa(request: ConsultaRequest):
    """
...
@router.post("/validar")
async def validar_parametro(request: ValidacionParametroRequest):
    """
...
async def listar_normas():
    ...
    """
    base = BaseConocimientoNormativo()
...
async def obtener_limites_normativos(ambito: str):
    ...
    limites = {
        "urbano": {
            "presion_minima": {"valor": settings.PRESION_MINIMA_URBANA, "unidad": "m.c.a.", "norma": "RNE OS.050"},
            "presion_maxima": {"valor": settings.PRESION_ESTATICA_MAXIMA, "unidad": "m.c.a.", "norma": "RNE OS.050"},
            "velocidad_minima": {"valor": settings.VELOCIDAD_MINIMA, "unidad": "m/s", "norma": "RNE OS.050"},
            "velocidad_maxima": {"valor": settings.VELOCIDAD_MAXIMA, "unidad": "m/s", "norma": "RNE OS.050"},
            "diametro_minimo": {"valor": settings.DIAMETRO_MINIMO_URBANO, "unidad": "mm", "norma": "RNE OS.050"},
            "dotacion_clima_calido": {"valor": settings.DOTACION_CLIMA_CALIDO, "unidad": "lppd", "norma": "RM 107-2025"},
            "dotacion_clima_templado": {"valor": settings.DOTACION_CLIMA_TEMPLADO, "unidad": "lppd", "norma": "RM 107-2025"},
            "dotacion_clima_frio": {"valor": settings.DOTACION_CLIMA_FRIO, "unidad": "lppd", "norma": "RM 107-2025"}
        },
        "rural": {
            "presion_minima": {"valor": settings.PRESION_MINIMA_RURAL, "unidad": "m.c.a.", "norma": "RM 192-2018"},
            "presion_minima_piletas": {"valor": settings.PRESION_MINIMA_PILETAS, "unidad": "m.c.a.", "norma": "RM 192-2018"},
            "velocidad_minima": {"valor": settings.VELOCIDAD_MINIMA, "unidad": "m/s", "norma": "RNE OS.050"},
            "velocidad_maxima": {"valor": settings.VELOCIDAD_MAXIMA, "unidad": "m/s", "norma": "RNE OS.050"},
            "diametro_minimo": {"valor": settings.DIAMETRO_MINIMO_RURAL, "unidad": "mm", "norma": "RM 192-2018"}
        }
    }
    
    return {
        "ambito": ambito,
        "limites": limites[ambito]
    }
