...
export const tramoCreateSchema = z.object({
    codigo: z.string().min(1).max(50).optional(), // Auto-generated by server action if not provided
    ...
    diametro_interior: z.number().positive('El diámetro debe ser mayor a 0').default(26.2), // Default 1" PVC
    clase_tuberia: z.string().default('CL-10'),
    coef_hazen_williams: z.number().positive().default(150),
    source_handle: z.string().optional(), // ReactFlow handle IDs
